...
- Prefer the open-access version (arXiv, author copy, PMC) when the version of record is paywalled. Note which version was read in `processing_notes.md`, since arXiv and published versions can differ.
